...
{
    /// <summary>
    /// Global BUSK.Charting configuration
    /// </summary>
    public class Charting
    {
        ...
        static Charting()
        {
            ...
            //we just mapped them correctly and BUSK.Charting will know how to handle this class.
        ...
        public static void For<T>(object config, SeriesOrientation orientation = SeriesOrientation.All)
        {
            ...
            if (!Configurations.TryGetValue(t, out ConfigWrapper wrapper))
            {
        ...
        public object GetConfig<T>(SeriesOrientation orientation = SeriesOrientation.Horizontal)
        {
            ...
            if (!Configurations.TryGetValue(typeof(T), out ConfigWrapper wrapper))
                throw new BUSKChartingException("BUSK.Charting does not know how to plot " + typeof(T).Name + ", " +
