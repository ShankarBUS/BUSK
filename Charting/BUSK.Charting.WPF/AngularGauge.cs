    ...
    public class AngularGauge : UserControl
    {
        ...
        internal void Draw()
        {
            ...
            if (ts / (FromValue - ToValue) > 300)
                throw new BUSKChartingException("TicksStep property is too small compared with the range in " +
            ...
            if (ls / (FromValue - ToValue) > 300)
                throw new BUSKChartingException("LabelsStep property is too small compared with the range in " +
                                              "the gauge, to avoid performance issues, please increase it.");
