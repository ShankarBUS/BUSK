...
namespace BUSK.Charting.WPF
{
    ...
    public partial class DefaultTooltip : IChartTooltip
    {
        ...
        /// <summary>
        /// Gets or sets the tooltip selection mode, default is null, if this property is null BUSK.Charting will decide the selection mode based on the series (that fired the tooltip) preferred section mode
        /// </summary>
